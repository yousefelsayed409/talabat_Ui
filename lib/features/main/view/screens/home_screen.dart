...
import 'package:talabat/features/main/data/models/category_model.dart';
import 'package:talabat/features/main/data/models/shortcut_model.dart';
import 'package:talabat/features/main/view/widgets/custom__appbar_section_home.dart';
import 'package:talabat/features/main/view/widgets/custom_categories_section_home_screen.dart';
import 'package:talabat/features/main/view/widgets/custom_popular_section_home.dart';
import 'package:talabat/features/main/view/widgets/custom_shortcut_section_home.dart';

class HomeScreen extends StatefulWidget {
  const HomeScreen({super.key, this.userLocation});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
             CustomAppBarSectionHomeScreen(userLocation: widget.userLocation),
            SizedBox(
